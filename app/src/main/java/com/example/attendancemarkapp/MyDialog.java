...
public class MyDialog extends DialogFragment {
    ...
    private Dialog getUpdateStudentDialog() {
        ...
        EditText roll_edit = view.findViewById(R.id.class_edit);
        EditText name_edit = view.findViewById(R.id.subject_edit);

        roll_edit.setHint("Student ID");
    ...
    private Dialog getUpdateClassDialog() {
        ...
        EditText class_edit = view.findViewById(R.id.class_edit);
        EditText subject_edit = view.findViewById(R.id.subject_edit);
